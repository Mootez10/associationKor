                ...
                <div class="container">
                    <div class="sec-title text-center">
                        <div class="sec-title-innerr">
                            <h3>مدرسي الإملاءت النسائية </h3> 
                        </div>
                    </div>
                    <div class="team-wrap text-center remove-ext5">
                        <div class="row">
                            @foreach ($teacher_level5s as $teacher_level5)
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="team-box">
                                    <img src="assets/images/resources/{{ $teacher_level5->picture }}" alt="cyrine.jpg">
                                    <div class="team-info">
                                        <h4>{{ $teacher_level5->name }}</h4>
                                        <p>{{ $teacher_level5->job }}</p>
                                        <div class="team-scl">
