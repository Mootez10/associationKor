                ...
                <div class="container">
                    <div class="sec-title text-center">
                        <div class="sec-title-innerr">
                            <h3>مدرسي الإملاءت الرجالية </h3> 
                        </div>
                    </div>
                    <div class="team-wrap text-center remove-ext5">
                        <div class="row">
                            @foreach ($teacher_level4s as $teacher_level4)
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="team-box">
                                    <img src="assets/images/resources/{{ $teacher_level4->picture }}" alt="cyrine.jpg">
                                    <div class="team-info">
                                        <h4>{{ $teacher_level4->name }}</h4>
                                        <p>{{ $teacher_level4->job }}</p>
                                        <div class="team-scl">
